...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %5 = load <6 x i8>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %6 = load <8 x i8>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %7 = load <16 x i8>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %8 = load <32 x i8>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %9 = load <vscale x 1 x i8>, ptr %p, align 1
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %10 = load <vscale x 2 x i8>, ptr %p, align 2
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %11 = load <vscale x 4 x i8>, ptr %p, align 4
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %12 = load <vscale x 8 x i8>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %13 = load <vscale x 16 x i8>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %14 = load <vscale x 32 x i8>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %15 = load i16, ptr %p, align 2
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %16 = load <1 x i16>, ptr %p, align 2
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %17 = load <2 x i16>, ptr %p, align 4
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %18 = load <4 x i16>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %19 = load <6 x i16>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %20 = load <8 x i16>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %21 = load <16 x i16>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %22 = load <32 x i16>, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %23 = load <vscale x 1 x i16>, ptr %p, align 2
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %24 = load <vscale x 2 x i16>, ptr %p, align 4
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %25 = load <vscale x 4 x i16>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %26 = load <vscale x 8 x i16>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %27 = load <vscale x 16 x i16>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %28 = load <vscale x 32 x i16>, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %29 = load i32, ptr %p, align 4
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %30 = load <1 x i32>, ptr %p, align 4
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %31 = load <2 x i32>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %32 = load <4 x i32>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %33 = load <6 x i32>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %34 = load <8 x i32>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %35 = load <16 x i32>, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %36 = load <32 x i32>, ptr %p, align 128
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %37 = load <vscale x 1 x i32>, ptr %p, align 4
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %38 = load <vscale x 2 x i32>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %39 = load <vscale x 4 x i32>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %40 = load <vscale x 8 x i32>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %41 = load <vscale x 16 x i32>, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %42 = load <vscale x 32 x i32>, ptr %p, align 128
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %43 = load i64, ptr %p, align 4
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %44 = load <1 x i64>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %45 = load <2 x i64>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %46 = load <4 x i64>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %47 = load <6 x i64>, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %48 = load <8 x i64>, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %49 = load <16 x i64>, ptr %p, align 128
; CHECK-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %50 = load <32 x i64>, ptr %p, align 256
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %51 = load <vscale x 1 x i64>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %52 = load <vscale x 2 x i64>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %53 = load <vscale x 4 x i64>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %54 = load <vscale x 8 x i64>, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %55 = load <vscale x 16 x i64>, ptr %p, align 128
; CHECK-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %56 = load <vscale x 32 x i64>, ptr %p, align 256
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %57 = load ptr, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %58 = load <1 x ptr>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %59 = load <2 x ptr>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %60 = load <4 x ptr>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %61 = load <6 x ptr>, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %62 = load <8 x ptr>, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %63 = load <16 x ptr>, ptr %p, align 128
; CHECK-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %64 = load <32 x ptr>, ptr %p, align 256
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %65 = load <vscale x 1 x ptr>, ptr %p, align 8
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %66 = load <vscale x 2 x ptr>, ptr %p, align 16
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %67 = load <vscale x 4 x ptr>, ptr %p, align 32
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %68 = load <vscale x 8 x ptr>, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %69 = load <vscale x 16 x ptr>, ptr %p, align 128
; CHECK-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %70 = load <vscale x 32 x ptr>, ptr %p, align 256
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: store <6 x i8> undef, ptr %p, align 8
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: store <6 x i64> undef, ptr %p, align 64
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: store <6 x ptr> undef, ptr %p, align 64
