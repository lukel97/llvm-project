...
; RV32-NEXT:    vle8.v v8, (a0)
; RV32-NEXT:    vmseq.vi v8, v8, 0
; RV32-NEXT:    vsetivli zero, 1, e16, mf8, ta, ma
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    srl a0, a0, a1
; RV32-NEXT:    andi a0, a0, 1
; RV32-NEXT:    ret
...
; RV64-NEXT:    vle8.v v8, (a0)
; RV64-NEXT:    vmseq.vi v8, v8, 0
; RV64-NEXT:    vsetivli zero, 1, e16, mf8, ta, ma
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    srl a0, a0, a1
; RV64-NEXT:    andi a0, a0, 1
; RV64-NEXT:    ret
...
; RV32ZBS-NEXT:    vle8.v v8, (a0)
; RV32ZBS-NEXT:    vmseq.vi v8, v8, 0
; RV32ZBS-NEXT:    vsetivli zero, 1, e16, mf8, ta, ma
; RV32ZBS-NEXT:    vmv.x.s a0, v8
; RV32ZBS-NEXT:    bext a0, a0, a1
; RV32ZBS-NEXT:    ret
;
...
; RV64ZBS-NEXT:    vle8.v v8, (a0)
; RV64ZBS-NEXT:    vmseq.vi v8, v8, 0
; RV64ZBS-NEXT:    vsetivli zero, 1, e16, mf8, ta, ma
; RV64ZBS-NEXT:    vmv.x.s a0, v8
; RV64ZBS-NEXT:    bext a0, a0, a1
; RV64ZBS-NEXT:    ret
...
; RV64-NEXT:    vsetivli zero, 1, e32, mf8, ta, ma
...
; RV32ZBS-NEXT:    vsetivli zero, 1, e32, mf8, ta, ma
...
; RV64ZBS-NEXT:    vsetivli zero, 1, e32, mf8, ta, ma
...
; RV64-NEXT:    vsetivli zero, 1, e64, mf8, ta, ma
...
; RV64ZBS-NEXT:    vsetivli zero, 1, e64, mf8, ta, ma
