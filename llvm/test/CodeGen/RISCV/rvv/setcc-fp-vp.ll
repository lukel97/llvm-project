...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x2b, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 43 * vlenb
; CHECK-NEXT:    csrr a1, vlenb
; CHECK-NEXT:    mv a3, a1
; CHECK-NEXT:    slli a1, a1, 1
; CHECK-NEXT:    add a3, a3, a1
...
; CHECK-NEXT:    vslideup.vx v6, v8, a3
...
; ZVFHMIN-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x2b, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 43 * vlenb
; ZVFHMIN-NEXT:    csrr a1, vlenb
; ZVFHMIN-NEXT:    mv a3, a1
; ZVFHMIN-NEXT:    slli a1, a1, 1
; ZVFHMIN-NEXT:    add a3, a3, a1
...
; ZVFHMIN-NEXT:    vslideup.vx v6, v8, a3
