...
; RV32-NEXT:    vsll.vx v8, v24, a1, v0.t
; RV32-NEXT:    vor.vv v16, v8, v16, v0.t
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a2, 24
; RV32-NEXT:    mul a1, a1, a2
...
; RV32-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV32-NEXT:    vsrl.vi v16, v24, 24, v0.t
...
; RV32-NEXT:    addi a1, a1, 48
; RV32-NEXT:    vs8r.v v16, (a1) # Unknown-size Folded Spill
; RV32-NEXT:    vsrl.vi v16, v24, 8, v0.t
...
; CHECK-NEXT:    vsll.vi v16, v8, 8, v0.t
...
; CHECK-NEXT:    addi a5, a3, -241
; CHECK-NEXT:    addi a3, a4, 819
; CHECK-NEXT:    addi a0, a0, 1365
...
; CHECK-NEXT:    vor.vv v24, v8, v16, v0.t
...
; CHECK-NEXT:    vmv1r.v v0, v6
; CHECK-NEXT:    vsetvli zero, a1, e16, m8, ta, ma
; CHECK-NEXT:    vsrl.vi v16, v24, 2, v0.t
...
; CHECK-NEXT:    vor.vv v24, v24, v16, v0.t
; CHECK-NEXT:    vmv1r.v v0, v7
; CHECK-NEXT:    vsetvli zero, a2, e16, m8, ta, ma
