...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e16, mf8, tu, ma
...
; CHECK-NEXT:    vsetvli a2, zero, e16, mf8, ta, ma
; CHECK-NEXT:    vfmv.s.f v9, fa0
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a1, zero, e16, mf8, ta, ma
; CHECK-NEXT:    vfmv.s.f v10, fa0
; CHECK-NEXT:    addi a1, a0, 1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e32, mf8, tu, ma
; CHECK-NEXT:    vfmv.s.f v8, fa0
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    addi a1, a0, 1
; CHECK-NEXT:    vsetvli a2, zero, e32, mf8, ta, ma
; CHECK-NEXT:    vfmv.s.f v9, fa0
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a1, zero, e32, mf8, ta, ma
; CHECK-NEXT:    vfmv.s.f v10, fa0
; CHECK-NEXT:    addi a1, a0, 1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e64, mf8, tu, ma
; CHECK-NEXT:    vfmv.s.f v8, fa0
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    addi a1, a0, 1
; CHECK-NEXT:    vsetvli a2, zero, e64, mf8, ta, ma
; CHECK-NEXT:    vfmv.s.f v9, fa0
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a1, zero, e64, mf8, ta, ma
; CHECK-NEXT:    vfmv.s.f v10, fa0
; CHECK-NEXT:    addi a1, a0, 1
