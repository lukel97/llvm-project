...
; FIXME: This shouldn't be folded because changing the VL affects the result
define <vscale x 2 x i32> @unfoldable_vreduce(<vscale x 2 x i32> %passthru, <vscale x 4 x i32> %x, <vscale x 2 x i32> %y) {
; CHECK-LABEL: unfoldable_vreduce:
; CHECK:       # %bb.0:
