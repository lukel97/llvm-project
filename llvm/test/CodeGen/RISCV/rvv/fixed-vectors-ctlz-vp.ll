...
; RV32-NEXT:    vl8r.v v16, (a4) # Unknown-size Folded Reload
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV32-NEXT:    vsrl.vi v8, v16, 16, v0.t
; RV32-NEXT:    csrr a4, vlenb
; RV32-NEXT:    slli a4, a4, 5
; RV32-NEXT:    add a4, sp, a4
; RV32-NEXT:    addi a4, a4, 48
...
; RV64-NEXT:    add t0, sp, t0
; RV64-NEXT:    addi t0, t0, 16
; RV64-NEXT:    vl8r.v v8, (t0) # Unknown-size Folded Reload
...
; RV64-NEXT:    vl8r.v v16, (t0) # Unknown-size Folded Reload
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vsrl.vi v8, v16, 16, v0.t
; RV64-NEXT:    csrr t0, vlenb
; RV64-NEXT:    li t1, 24
; RV64-NEXT:    mul t0, t0, t1
; RV64-NEXT:    add t0, sp, t0
...
; RV64-NEXT:    vl8r.v v16, (t0) # Unknown-size Folded Reload
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vsrl.vx v8, v16, a7, v0.t
; RV64-NEXT:    csrr t0, vlenb
; RV64-NEXT:    li t1, 24
; RV64-NEXT:    mul t0, t0, t1
; RV64-NEXT:    add t0, sp, t0
...
; RV64-NEXT:    add a7, sp, a7
; RV64-NEXT:    addi a7, a7, 16
; RV64-NEXT:    vl8r.v v16, (a7) # Unknown-size Folded Reload
; RV64-NEXT:    vsetvli zero, a4, e64, m8, ta, ma
