...
define <8 x i16> @sdiv_v8i16_splat_rhs(<8 x i16> %x, i16 %y, <8 x i1> %m) {
; CHECK-LABEL: sdiv_v8i16_splat_rhs:
; CHECK:       # %bb.0:
...
; CHECK-NEXT:    ret
  ...
  %res = call <8 x i16> @llvm.masked.sdiv(<8 x i16> %x, <8 x i16> %splat, <8 x i1> %m)
  ret <8 x i16> %res
}
