...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a1, zero, e16, mf8, tu, ma
; CHECK-NEXT:    vmv.s.x v8, a0
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    addi a2, a1, 1
; CHECK-NEXT:    vsetvli a3, zero, e16, mf8, ta, ma
; CHECK-NEXT:    vmv.s.x v9, a0
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a1, zero, e32, mf8, tu, ma
; CHECK-NEXT:    vmv.s.x v8, a0
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    addi a2, a1, 1
; CHECK-NEXT:    vsetvli a3, zero, e32, mf8, ta, ma
; CHECK-NEXT:    vmv.s.x v9, a0
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a1, zero, e64, mf8, tu, ma
; CHECK-NEXT:    vmv.s.x v8, a0
; CHECK-NEXT:    ret
