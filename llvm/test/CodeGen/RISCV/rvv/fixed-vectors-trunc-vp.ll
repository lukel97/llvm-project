...
; CHECK-NEXT:  .LBB16_8:
; CHECK-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; CHECK-NEXT:    vslidedown.vi v13, v3, 2
; CHECK-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; CHECK-NEXT:    add a5, sp, a5
; CHECK-NEXT:    addi a5, a5, 16
; CHECK-NEXT:    vs1r.v v1, (a5) # Unknown-size Folded Spill
; CHECK-NEXT:    vslidedown.vi v12, v1, 2
; CHECK-NEXT:    csrr a5, vlenb
; CHECK-NEXT:    slli a5, a5, 3
; CHECK-NEXT:    add a5, sp, a5
; CHECK-NEXT:    addi a5, a5, 16
; CHECK-NEXT:    vs1r.v v12, (a5) # Unknown-size Folded Spill
...
; CHECK-NEXT:    addi a1, a1, 16
; CHECK-NEXT:    vl8r.v v16, (a1) # Unknown-size Folded Reload
; CHECK-NEXT:    vslideup.vi v16, v0, 16
; CHECK-NEXT:    csrr a1, vlenb
; CHECK-NEXT:    li a4, 50
; CHECK-NEXT:    mul a1, a1, a4
; CHECK-NEXT:    add a1, sp, a1
