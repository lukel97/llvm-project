...
; RV32-NEXT:    vnot.v v9, v8, v0.t
; RV32-NEXT:    vsub.vx v8, v8, a1, v0.t
...
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vand.vv v8, v9, v8, v0.t
...
; RV32-NEXT:    addi a1, a1, 819
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vand.vv v8, v10, v8, v0.t
...
; RV32-NEXT:    vsub.vx v8, v8, a2, v0.t
...
; RV64-NEXT:    li a0, 56
; RV64-NEXT:    vsub.vx v8, v8, a6, v0.t
...
; RV64-NEXT:    add t0, sp, t0
; RV64-NEXT:    addi t0, t0, 16
; RV64-NEXT:    vl8r.v v16, (t0) # Unknown-size Folded Reload
; RV64-NEXT:    vsetvli zero, a4, e64, m8, ta, ma
; RV64-NEXT:    vsub.vx v8, v16, a6, v0.t
...
; RV64-NEXT:    add a6, sp, a6
; RV64-NEXT:    addi a6, a6, 16
; RV64-NEXT:    vl8r.v v16, (a6) # Unknown-size Folded Reload
; RV64-NEXT:    vand.vv v16, v8, v16, v0.t
; RV64-NEXT:    csrr a6, vlenb
; RV64-NEXT:    slli a6, a6, 4
; RV64-NEXT:    add a6, sp, a6
; RV64-NEXT:    addi a6, a6, 16
; RV64-NEXT:    vs8r.v v16, (a6) # Unknown-size Folded Spill
; RV64-NEXT:    vmv1r.v v0, v25
; RV64-NEXT:    csrr a6, vlenb
...
; RV64-NEXT:    vl8r.v v16, (a6) # Unknown-size Folded Reload
; RV64-NEXT:    vsetvli zero, a4, e64, m8, ta, ma
; RV64-NEXT:    vand.vx v8, v16, a5, v0.t
; RV64-NEXT:    csrr a6, vlenb
; RV64-NEXT:    li a7, 24
; RV64-NEXT:    mul a6, a6, a7
; RV64-NEXT:    add a6, sp, a6
