...
; RV32-NEXT:    addi a1, sp, 16
; RV32-NEXT:    vs1r.v v21, (a1) # Unknown-size Folded Spill
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a3, 45
; RV32-NEXT:    mul a1, a1, a3
; RV32-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    vs1r.v v6, (a1) # Unknown-size Folded Spill
; RV64-NEXT:    vrgather.vi v8, v16, 2, v0.t
; RV64-NEXT:    vmv.v.v v20, v8
; RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-NEXT:    li a1, 6
; RV64-NEXT:    vid.v v8
; RV64-NEXT:    vmul.vx v4, v8, a1
...
; RV64-NEXT:    vadd.vi v16, v4, -14
; RV64-NEXT:    vmv2r.v v22, v4
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
...
; RV64-NEXT:    addi a1, sp, 16
; RV64-NEXT:    vl1r.v v21, (a1) # Unknown-size Folded Reload
...
; RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-NEXT:    vmv2r.v v2, v22
; RV64-NEXT:    vadd.vi v16, v22, 3
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    slli a1, a1, 5
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v24, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgatherei16.vv v28, v24, v12
; RV64-NEXT:    vmv1r.v v0, v21
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    slli a1, a1, 4
; RV64-NEXT:    add a1, sp, a1
