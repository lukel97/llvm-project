...
; RV32-NEXT:    vslideup.vi v20, v8, 2
...
; RV32-NEXT:    vsetivli zero, 16, e32, m4, ta, mu
; RV32-NEXT:    vslideup.vi v20, v16, 8, v0.t
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a2, 44
...
; RV32-NEXT:    vrgatherei16.vv v16, v4, v8
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a2, 28
; RV32-NEXT:    mul a1, a1, a2
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl4r.v v24, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vrgatherei16.vv v4, v24, v8
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a2, 36
; RV32-NEXT:    mul a1, a1, a2
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vl4r.v v24, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vrgatherei16.vv v28, v24, v1
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a2, 52
; RV32-NEXT:    mul a1, a1, a2
; RV32-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    vrgatherei16.vv v16, v24, v4
; RV64-NEXT:    csrr a3, vlenb
; RV64-NEXT:    li a4, 54
; RV64-NEXT:    mul a3, a3, a4
; RV64-NEXT:    add a3, sp, a3
...
; RV64-NEXT:    li a1, 64
; RV64-NEXT:    vmv.s.x v0, a1
; RV64-NEXT:    vmv4r.v v20, v16
; RV64-NEXT:    vslideup.vi v20, v16, 5, v0.t
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 10
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    vmerge.vvm v20, v20, v12, v0
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 22
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    vmerge.vvm v8, v4, v8, v0
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 30
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
