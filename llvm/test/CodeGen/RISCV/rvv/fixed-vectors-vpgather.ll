...
; RV32-NEXT:    vsll.vi v24, v12, 3
; RV32-NEXT:    vsetivli zero, 16, e16, m4, ta, ma
; RV32-NEXT:    vslidedown.vi v12, v24, 16
; RV32-NEXT:    addi a2, a1, -16
; RV32-NEXT:    sltu a3, a1, a2
; RV32-NEXT:    addi a3, a3, -1
; RV32-NEXT:    and a2, a3, a2
...
; RV32-NEXT:    vslidedown.vi v0, v0, 2
; RV32-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV32-NEXT:    vluxei16.v v16, (a0), v12, v0.t
; RV32-NEXT:    li a2, 16
...
; RV64-NEXT:    vslidedown.vi v12, v24, 16
; RV64-NEXT:    addi a2, a1, -16
; RV64-NEXT:    sltu a3, a1, a2
; RV64-NEXT:    addi a3, a3, -1
; RV64-NEXT:    and a2, a3, a2
...
; RV64-NEXT:    vslidedown.vi v0, v0, 2
; RV64-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV64-NEXT:    vluxei16.v v16, (a0), v12, v0.t
; RV64-NEXT:    li a2, 16
