...
; CHECK-NEXT:    [[TMP36:%.*]] = getelementptr inbounds nuw i16, ptr [[PRED]], i64 [[TMP0]]
; CHECK-NEXT:    [[TMP37:%.*]] = getelementptr inbounds nuw i16, ptr [[PRED]], i64 [[TMP25]]
; CHECK-NEXT:    [[TMP38:%.*]] = getelementptr inbounds nuw i16, ptr [[PRED]], i64 [[TMP26]]
; CHECK-NEXT:    [[TMP39:%.*]] = load i16, ptr [[TMP1]], align 2
; CHECK-NEXT:    [[TMP40:%.*]] = load i16, ptr [[TMP36]], align 2
; CHECK-NEXT:    [[TMP41:%.*]] = load i16, ptr [[TMP37]], align 2
; CHECK-NEXT:    [[TMP42:%.*]] = load i16, ptr [[TMP38]], align 2
; CHECK-NEXT:    [[TMP43:%.*]] = insertelement <4 x i16> poison, i16 [[TMP39]], i64 0
; CHECK-NEXT:    [[TMP44:%.*]] = insertelement <4 x i16> [[TMP43]], i16 [[TMP40]], i64 1
; CHECK-NEXT:    [[TMP45:%.*]] = insertelement <4 x i16> [[TMP44]], i16 [[TMP41]], i64 2
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = insertelement <4 x i16> [[TMP45]], i16 [[TMP42]], i64 3
