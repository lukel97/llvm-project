...
; CHECK-NEXT:    [[DOTSPLATINSERT:%.*]] = insertelement <vscale x 4 x i32> undef, i32 [[TMP8]], i64 0
...
; CHECK-NEXT:    [[TMP10:%.*]] = uitofp <vscale x 4 x i64> [[BROADCAST_SPLAT]] to <vscale x 4 x float>
; CHECK-NEXT:    [[DOTSPLAT:%.*]] = fmul <vscale x 4 x float> [[TMP10]], splat (float 2.000000e+00)
; CHECK-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK:       vector.body:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
