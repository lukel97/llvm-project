...
define void @blend_poison(i1 %c1, i1 %c2, i1 %c3, i32 %x, i32 %y, ptr %p) {
...
; CHECK-NEXT:    [[PREDPHI:%.*]] = select <4 x i1> [[TMP1]], <4 x i32> poison, <4 x i32> [[BROADCAST_SPLAT]]
