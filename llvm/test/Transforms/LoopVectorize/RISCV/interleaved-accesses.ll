...
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr i64, ptr [[P:%.*]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i64, ptr [[TMP2]], i32 0
; CHECK-NEXT:    [[WIDE_VEC:%.*]] = load <32 x i64>, ptr [[TMP3]], align 4
; CHECK-NEXT:    [[STRIDED_VEC:%.*]] = shufflevector <32 x i64> [[WIDE_VEC]], <32 x i64> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
; CHECK-NEXT:    [[STRIDED_VEC1:%.*]] = shufflevector <32 x i64> [[WIDE_VEC]], <32 x i64> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
; CHECK-NEXT:    [[STRIDED_VEC2:%.*]] = shufflevector <32 x i64> [[WIDE_VEC]], <32 x i64> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
; CHECK-NEXT:    [[STRIDED_VEC3:%.*]] = shufflevector <32 x i64> [[WIDE_VEC]], <32 x i64> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
; CHECK-NEXT:    [[STRIDED_VEC4:%.*]] = shufflevector <32 x i64> [[WIDE_VEC]], <32 x i64> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
; CHECK-NEXT:    [[STRIDED_VEC5:%.*]] = shufflevector <32 x i64> [[WIDE_VEC]], <32 x i64> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
; CHECK-NEXT:    [[STRIDED_VEC6:%.*]] = shufflevector <32 x i64> [[WIDE_VEC]], <32 x i64> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
; CHECK-NEXT:    [[STRIDED_VEC7:%.*]] = shufflevector <32 x i64> [[WIDE_VEC]], <32 x i64> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
; CHECK-NEXT:    [[TMP4:%.*]] = add <4 x i64> [[STRIDED_VEC]], <i64 1, i64 1, i64 1, i64 1>
; CHECK-NEXT:    [[TMP5:%.*]] = add i64 [[TMP1]], 1
; CHECK-NEXT:    [[TMP6:%.*]] = add <4 x i64> [[STRIDED_VEC1]], <i64 2, i64 2, i64 2, i64 2>
; CHECK-NEXT:    [[TMP7:%.*]] = add i64 [[TMP5]], 1
; CHECK-NEXT:    [[TMP8:%.*]] = add <4 x i64> [[STRIDED_VEC2]], <i64 3, i64 3, i64 3, i64 3>
; CHECK-NEXT:    [[TMP9:%.*]] = add i64 [[TMP7]], 1
; CHECK-NEXT:    [[TMP10:%.*]] = add <4 x i64> [[STRIDED_VEC3]], <i64 4, i64 4, i64 4, i64 4>
; CHECK-NEXT:    [[TMP11:%.*]] = add i64 [[TMP9]], 1
; CHECK-NEXT:    [[TMP12:%.*]] = add <4 x i64> [[STRIDED_VEC4]], <i64 5, i64 5, i64 5, i64 5>
; CHECK-NEXT:    [[TMP13:%.*]] = add i64 [[TMP11]], 1
; CHECK-NEXT:    [[TMP14:%.*]] = add <4 x i64> [[STRIDED_VEC5]], <i64 6, i64 6, i64 6, i64 6>
; CHECK-NEXT:    [[TMP15:%.*]] = add i64 [[TMP13]], 1
; CHECK-NEXT:    [[TMP16:%.*]] = add <4 x i64> [[STRIDED_VEC6]], <i64 7, i64 7, i64 7, i64 7>
; CHECK-NEXT:    [[TMP17:%.*]] = add i64 [[TMP15]], 1
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr i64, ptr [[P]], i64 [[TMP17]]
; CHECK-NEXT:    [[TMP19:%.*]] = add <4 x i64> [[STRIDED_VEC7]], <i64 8, i64 8, i64 8, i64 8>
; CHECK-NEXT:    [[TMP20:%.*]] = getelementptr i64, ptr [[TMP18]], i32 -7
; CHECK-NEXT:    [[TMP21:%.*]] = shufflevector <4 x i64> [[TMP4]], <4 x i64> [[TMP6]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP22:%.*]] = shufflevector <4 x i64> [[TMP8]], <4 x i64> [[TMP10]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP23:%.*]] = shufflevector <4 x i64> [[TMP12]], <4 x i64> [[TMP14]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP24:%.*]] = shufflevector <4 x i64> [[TMP16]], <4 x i64> [[TMP19]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i64> [[TMP21]], <8 x i64> [[TMP22]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP26:%.*]] = shufflevector <8 x i64> [[TMP23]], <8 x i64> [[TMP24]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP27:%.*]] = shufflevector <16 x i64> [[TMP25]], <16 x i64> [[TMP26]], <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
; CHECK-NEXT:    [[INTERLEAVED_VEC:%.*]] = shufflevector <32 x i64> [[TMP27]], <32 x i64> poison, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
; CHECK-NEXT:    store <32 x i64> [[INTERLEAVED_VEC]], ptr [[TMP20]], align 4
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
