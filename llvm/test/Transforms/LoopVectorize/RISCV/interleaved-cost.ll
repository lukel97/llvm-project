...
; VF_16:       Found an estimated cost of 54 for VF 16 For instruction:   %l0 = load i8, ptr %p0, align 1
; VF_16-NEXT:  Found an estimated cost of 0 for VF 16 For instruction:   %l1 = load i8, ptr %p1, align 1
...
; VF_16-NEXT:  Found an estimated cost of 54 for VF 16 For instruction:   store i8 %a2, ptr %p2, align 1
for.body:
  %i = phi i64 [ 0, %entry ], [ %i.next, %for.body ]
