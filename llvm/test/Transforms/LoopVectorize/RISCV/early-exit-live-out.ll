...
; RV64:       [[LOOP1]]:
; RV64-NEXT:    [[IV:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY_INTERIM:.*]] ]
; RV64-NEXT:    [[GEP:%.*]] = getelementptr i32, ptr [[P]], i64 [[IV]]
; RV64-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 4 x i32>, ptr [[GEP]], align 4
; RV64-NEXT:    [[TMP5:%.*]] = icmp ne <vscale x 4 x i32> [[WIDE_LOAD]], zeroinitializer
; RV64-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[IV]], [[TMP3]]
...
; RV64-NEXT:    br i1 [[TMP8]], label %[[MIDDLE_BLOCK:.*]], label %[[LOOP1]], !llvm.loop [[LOOP0:![0-9]+]]
; RV64:       [[MIDDLE_BLOCK]]:
...
; RV64:       [[SCALAR_PH1]]:
; RV64-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], %[[MIDDLE_BLOCK]] ], [ 0, %[[SCALAR_PH]] ]
; RV64-NEXT:    br label %[[LOOP_HEADER:.*]]
; RV64:       [[LOOP_HEADER]]:
; RV64-NEXT:    [[IV1:%.*]] = phi i64 [ [[BC_RESUME_VAL]], %[[SCALAR_PH1]] ], [ [[IV_NEXT:%.*]], %[[LATCH:.*]] ]
; RV64-NEXT:    [[GEP1:%.*]] = getelementptr i32, ptr [[P]], i64 [[IV1]]
; RV64-NEXT:    [[LD:%.*]] = load i32, ptr [[GEP1]], align 4
; RV64-NEXT:    [[C:%.*]] = icmp eq i32 [[LD]], 0
; RV64-NEXT:    br i1 [[C]], label %[[LATCH]], label %[[EXIT]]
; RV64:       [[LATCH]]:
; RV64-NEXT:    [[IV_NEXT]] = add i64 [[IV1]], 1
...
; RV32-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH1:.*]], label %[[VECTOR_PH:.*]]
; RV32:       [[VECTOR_PH]]:
...
; RV32:       [[LOOP]]:
; RV32-NEXT:    [[IV:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY_INTERIM:.*]] ]
; RV32-NEXT:    [[GEP:%.*]] = getelementptr i32, ptr [[P]], i64 [[IV]]
; RV32-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 4 x i32>, ptr [[GEP]], align 4
; RV32-NEXT:    [[TMP5:%.*]] = icmp ne <vscale x 4 x i32> [[WIDE_LOAD]], zeroinitializer
; RV32-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[IV]], [[TMP3]]
...
; RV32-NEXT:    br i1 [[TMP8]], label %[[MIDDLE_BLOCK:.*]], label %[[LOOP]], !llvm.loop [[LOOP0:![0-9]+]]
; RV32:       [[MIDDLE_BLOCK]]:
; RV32-NEXT:    [[CMP_N:%.*]] = icmp eq i64 1024, [[N_VEC]]
; RV32-NEXT:    br i1 [[CMP_N]], label %[[EXIT:.*]], label %[[SCALAR_PH1]]
...
; RV32:       [[SCALAR_PH1]]:
; RV32-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], %[[MIDDLE_BLOCK]] ], [ 0, %[[SCALAR_PH]] ]
; RV32-NEXT:    br label %[[LOOP_HEADER:.*]]
; RV32:       [[LOOP_HEADER]]:
; RV32-NEXT:    [[IV1:%.*]] = phi i64 [ [[BC_RESUME_VAL]], %[[SCALAR_PH1]] ], [ [[IV_NEXT:%.*]], %[[LATCH:.*]] ]
; RV32-NEXT:    [[GEP1:%.*]] = getelementptr i32, ptr [[P]], i64 [[IV1]]
; RV32-NEXT:    [[LD:%.*]] = load i32, ptr [[GEP1]], align 4
; RV32-NEXT:    [[C:%.*]] = icmp eq i32 [[LD]], 0
; RV32-NEXT:    br i1 [[C]], label %[[LATCH]], label %[[EXIT]]
; RV32:       [[LATCH]]:
; RV32-NEXT:    [[IV_NEXT]] = add i64 [[IV1]], 1
...
; ZVE32X-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH1:.*]], label %[[VECTOR_PH:.*]]
; ZVE32X:       [[VECTOR_PH]]:
...
; ZVE32X:       [[LOOP1]]:
; ZVE32X-NEXT:    [[IV:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY_INTERIM:.*]] ]
; ZVE32X-NEXT:    [[GEP:%.*]] = getelementptr i32, ptr [[P]], i64 [[IV]]
; ZVE32X-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 4 x i32>, ptr [[GEP]], align 4
; ZVE32X-NEXT:    [[TMP5:%.*]] = icmp ne <vscale x 4 x i32> [[WIDE_LOAD]], zeroinitializer
; ZVE32X-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[IV]], [[TMP3]]
...
; ZVE32X-NEXT:    br i1 [[TMP8]], label %[[MIDDLE_BLOCK:.*]], label %[[LOOP1]], !llvm.loop [[LOOP0:![0-9]+]]
; ZVE32X:       [[MIDDLE_BLOCK]]:
; ZVE32X-NEXT:    [[CMP_N:%.*]] = icmp eq i64 1024, [[N_VEC]]
; ZVE32X-NEXT:    br i1 [[CMP_N]], label %[[EXIT1:.*]], label %[[SCALAR_PH1]]
...
; ZVE32X:       [[SCALAR_PH1]]:
; ZVE32X-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], %[[MIDDLE_BLOCK]] ], [ 0, %[[SCALAR_PH]] ]
; ZVE32X-NEXT:    br label %[[LOOP_HEADER:.*]]
; ZVE32X:       [[LOOP_HEADER]]:
; ZVE32X-NEXT:    [[IV1:%.*]] = phi i64 [ [[BC_RESUME_VAL]], %[[SCALAR_PH1]] ], [ [[IV_NEXT:%.*]], %[[LATCH1:.*]] ]
; ZVE32X-NEXT:    [[GEP1:%.*]] = getelementptr i32, ptr [[P]], i64 [[IV1]]
; ZVE32X-NEXT:    [[LD:%.*]] = load i32, ptr [[GEP1]], align 4
; ZVE32X-NEXT:    [[C:%.*]] = icmp eq i32 [[LD]], 0
; ZVE32X-NEXT:    br i1 [[C]], label %[[LATCH1]], label %[[EXIT1]]
; ZVE32X:       [[LATCH1]]:
; ZVE32X-NEXT:    [[IV_NEXT]] = add i64 [[IV1]], 1
; ZVE32X-NEXT:    [[EC:%.*]] = icmp eq i64 [[IV_NEXT]], 1024
; ZVE32X-NEXT:    br i1 [[EC]], label %[[EXIT1]], label %[[LOOP_HEADER]], !llvm.loop [[LOOP3:![0-9]+]]
; ZVE32X:       [[EXIT1]]:
; ZVE32X-NEXT:    [[RET:%.*]] = phi i32 [ [[LD]], %[[LOOP_HEADER]] ], [ 0, %[[LATCH1]] ], [ 0, %[[MIDDLE_BLOCK]] ], [ [[TMP9]], %[[VECTOR_EARLY_EXIT]] ]
