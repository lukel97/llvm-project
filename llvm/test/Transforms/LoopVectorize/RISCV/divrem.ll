...
; FIXED-NEXT:    [[TMP3:%.*]] = call <4 x i8> @llvm.vp.udiv.v4i8(<4 x i8> [[VEC_IND]], <4 x i8> [[BROADCAST_SPLAT2]], <4 x i1> [[TMP0]], i32 4)
; FIXED-NEXT:    [[TMP4:%.*]] = zext <4 x i8> [[TMP3]] to <4 x i16>
; FIXED-NEXT:    [[TMP5:%.*]] = call <4 x i16> @llvm.vp.sdiv.v4i16(<4 x i16> [[TMP4]], <4 x i16> [[BROADCAST_SPLAT4]], <4 x i1> [[TMP0]], i32 4)
