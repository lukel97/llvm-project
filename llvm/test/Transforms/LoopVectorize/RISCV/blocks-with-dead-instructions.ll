...
; CHECK-NEXT:    [[TMP14:%.*]] = mul <vscale x 8 x i64> [[DOTSPLAT]], splat (i64 3)
...
; CHECK-NEXT:    [[TMP11:%.*]] = mul <vscale x 4 x i64> [[DOTSPLAT]], splat (i64 3)
...
; CHECK-NEXT:    [[TMP21:%.*]] = mul <vscale x 2 x i64> [[DOTSPLAT]], splat (i64 3)
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
