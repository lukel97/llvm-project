...
; CHECK-NEXT:    [[TMP18:%.*]] = mul <vscale x 8 x i64> [[DOTSPLAT2]], splat (i64 3)
...
; CHECK-NEXT:    [[VEC_IND_NEXT]] = add <vscale x 8 x i64> [[VEC_IND]], [[TMP18]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = mul <vscale x 4 x i32> [[DOTSPLAT]], splat (i32 4)
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
...
; CHECK-NEXT:    [[TMP9:%.*]] = mul <vscale x 2 x i64> [[DOTSPLAT]], splat (i64 9)
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[VEC_IND_NEXT]] = add <vscale x 2 x i64> [[VEC_IND]], [[TMP9]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = mul <vscale x 4 x i64> [[DOTSPLAT]], splat (i64 2)
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
