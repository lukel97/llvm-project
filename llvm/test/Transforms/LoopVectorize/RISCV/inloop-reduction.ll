...
; IF-EVL-OUTLOOP-NEXT:    [[TMP8:%.*]] = shl i32 [[TMP5]], 1
; IF-EVL-OUTLOOP-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP7]], i32 [[TMP8]]
...
; IF-EVL-INLOOP-NEXT:    [[TMP9:%.*]] = shl i32 [[TMP6]], 1
; IF-EVL-INLOOP-NEXT:    [[TMP7]] = getelementptr i8, ptr [[TMP8]], i32 [[TMP9]]
