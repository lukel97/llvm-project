...
; IF-EVL:       vector.body:
; IF-EVL-NEXT:    [[TMP12:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP6:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP9]], 2
; IF-EVL-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP12]], i64 [[TMP5]]
...
; IF-EVL-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP8]], 2
; IF-EVL-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP12]], i64 [[TMP5]]
...
; IF-EVL-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP8]]
; IF-EVL-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP8]], 2
...
; IF-EVL-NEXT:    br label [[VECTOR_BODY:%.*]]
; IF-EVL:       vector.body:
; IF-EVL-NEXT:    [[TMP10:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[TMP13:%.*]] = phi ptr [ [[B:%.*]], [[VECTOR_PH]] ], [ [[TMP14:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP11]], 2
; IF-EVL-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP10]], i64 [[TMP7]]
; IF-EVL-NEXT:    [[TMP14]] = getelementptr i8, ptr [[TMP13]], i64 [[TMP7]]
