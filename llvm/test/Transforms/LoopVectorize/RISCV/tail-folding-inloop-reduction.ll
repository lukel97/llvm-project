...
; IF-EVL-NEXT:    [[TMP3:%.*]] = call <vscale x 4 x i1> @llvm.vp.merge.nxv4i1(<vscale x 4 x i1> splat (i1 true), <vscale x 4 x i1> [[TMP13]], <vscale x 4 x i1> zeroinitializer, i32 [[TMP11]])
; IF-EVL-NEXT:    [[TMP16]] = or <vscale x 4 x i1> [[VEC_PHI]], [[TMP3]]
; IF-EVL-NEXT:    [[TMP9:%.*]] = zext i32 [[TMP11]] to i64
; IF-EVL-NEXT:    [[INDEX_EVL_NEXT]] = add i64 [[TMP9]], [[EVL_BASED_IV]]
; IF-EVL-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP9]]
; IF-EVL-NEXT:    [[TMP10:%.*]] = icmp eq i64 [[AVL_NEXT]], 0
