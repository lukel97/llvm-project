...
enum NodeType {
  ...
  /// VECTOR_SPLICE_DOWN(VEC1, VEC2, OFFSET) - Shifts down CONCAT_VECTORS(VEC1,
  /// VEC2) by OFFSET elements and returns the lower half. If OFFSET is greater
  /// than the runtime number of elements in the result type, returns poison.
  VECTOR_SPLICE_DOWN,
  /// VECTOR_SPLICE_UP(VEC1, VEC2, OFFSET) - Shifts up CONCAT_VECTORS(VEC1,
  /// VEC2) by OFFSET elements and returns the upper half. If OFFSET is greater
  /// than the runtime number of elements in the result type, returns poison.
  VECTOR_SPLICE_UP,
