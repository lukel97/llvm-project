...
static VSETVLIInfo makeMoreSimilar(VSETVLIInfo PrevInfo, VSETVLIInfo NewInfo,
...
void RISCVInsertVSETVLI::transferBefore(VSETVLIInfo &Info,
  ...
  const VSETVLIInfo IncomingInfo = NewInfo;
  makeMoreSimilar(PrevInfo, NewInfo, Demanded, MRI);
